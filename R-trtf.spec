...
Version  : 0.3.9
Release  : 4
URL      : https://cran.r-project.org/src/contrib/trtf_0.3-9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/trtf_0.3-9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642183624
